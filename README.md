...
**2026-04-14**: 新增测试类型选择（旋转测试/垂直测试）、测试/挂起位置移动方案（先X后Z/先Z后X）、测量界面配置组实时显示当前位置和保存的位置

**2026-04-14**: 修复数据处理竞争条件 - `process_measure_data` 缓冲区检查逻辑修复、测试进度对话框优化、测量界面与测试配置面板同步更新
